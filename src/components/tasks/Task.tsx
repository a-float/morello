                ...
                {(provided, snapshot) => (
                    ...
                    >
                        ...
                        <CardContent sx={{ padding: "0", "&:last-child": { "paddingBottom": "0" } }} onDoubleClick={startEdit}>
                            ...
                            <Typography variant='subtitle1' sx={{ wordBreak: "break-word", lineHeight: '1.2' }} component="div">

                                {props.name}
                            </Typography>
                            {props.descr && <Typography variant='body1' sx={{ whiteSpace: "pre-line", fontSize: "0.9rem", marginTop: "0.32em", lineHeight: '1.15', color: "text.secondary" }}>
                                {props.descr}
                            </Typography>}
                        </CardContent>
                    </Card >
